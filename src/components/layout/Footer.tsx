    ...
    <footer className="bg-gray-950 pt-12">
      <div className="grid grid-cols-2 md:grid-cols-5 gap-10 mb-6 px-10 lg:px-48">
        <div className="col-span-full lg:col-span-1 lg:block">
          <Link href="/" className='text-primary text-2xl font-josefin'>Hotspot24</Link>
        ...
        <div>
          ...
          Passionate about delivering unforgettable experiences with every savory dish we deliver.</p>
        </div>
        ...
        <div>
          ...
          <div className="mt-6 grid space-y-2 text-gray-400">
            <p><Link className="inline-flex gap-x-2 hover:text-gray-200" href="/branches">Dine-In</Link></p>
            <p><Link className="inline-flex gap-x-2 hover:text-gray-200" href="/branches">Online Ordering</Link></p>
            <p><Link className="inline-flex gap-x-2 hover:text-gray-200" href="/branches">Catering</Link></p>
            <p><Link className="inline-flex gap-x-2 hover:text-gray-200" href="/branches">Specialty dishes</Link></p>
          </div>
        </div>
